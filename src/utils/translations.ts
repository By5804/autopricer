const translations: Record<string, string> = {
  ...
  "logic.onlySellerSetMax": "Anda satu-satunya penjual. Mengatur harga ke Maksimum Rp {{newPrice}}.",
  "logic.onlySellerAtMax": "Anda satu-satunya penjual dan sudah di harga Maksimum.",
  "logic.maximizeProfit": "Memaksimalkan profit terhadap kompetitor #2 ({{competitorStoreName}}) menjadi Rp {{newPrice}}.",
  ...
  "logic.undercutting": "Memotong harga {{competitorStoreName}} menjadi Rp {{newPrice}} (rank #{{rank}}).",
